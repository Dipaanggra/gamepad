<div class="flex items-center">
    <svg id="logo-40" width="171" height="32" viewBox="0 0 64 32" fill="none" xmlns="http://www.w3.org/2000/svg"
        {{ $attributes }}>
        <path d="M0 16C0 7.16344 7.16344 0 16 0H37C45.8366 0 53 7.16344 53 16V32H16C7.16344 32 0 24.8366 0 16Z"
    ...
    <h1 class="text-4xl font-bold text-blue-700">GamePad</h1>
</div>
