<nav class="h-screen border-r w-64 fixed bg-white sm:block hidden">
    <ul class="flex flex-col p-2 gap-2">
        ...
        <a href="{{ route('dashboard') }}" class="px-4 py-2 border rounded-lg">
            Dashboard
        </a>
        <a href="{{ route('game.index') }}" class="px-4 py-2 border rounded-lg">
            Games
        </a>
        @hasrole('admin')
            <a href="{{ route('user.index') }}" class="px-4 py-2 border rounded-lg">
                Users
            </a>
        @endhasrole
    </ul>
